...
<body class="hold-transition sidebar-mini" style="background: linear-gradient(to right, antiquewhite, #79093a);">
<div class="wrapper">
...
confirm_password.onkeyup = validatePassword;
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      ...
      <strong>Copyright &copy; <?php echo date('Y'); ?> Developed By <a target="_blank" href="http://facebook.com/narbie1995">MV AMAL</a>.</strong> All rights
