...
<body class="hold-transition sidebar-mini" style="background: linear-gradient(to right, #020024, #79093a, #00d4ff);">
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <td>". $row['status']. "</td>";
		    print 
        '<td><a title="Reactivate Exam for '.$row['student_name'].'" ';?> onclick="return confirm('Are you sure you want to reactivate exam for <?php echo $row['student_name']; ?> ?');" <?php print ' class="btn btn-block btn-danger " href="retake_ex.php?ref='.$row["student_no"].'">Retake exam<i class="fa fa-refresh"></i></a>
...
$conn->close();
  ...
  <footer class="main-footer">
	...
	<?php
      ...
      <strong>Copyright &copy; <?php echo date('Y'); ?> Developed By MV AMAL</a>.</strong> All rights
      reserved Department of Computer application.
  </footer>
