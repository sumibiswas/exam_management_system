  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="header" style="color: whitesmoke">SYSTEM</li>
     	  <li class="treeview">
          <a href="#">
...
?>
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      ...
      <strong>Copyright &copy; <?php echo date('Y'); ?> Developed By <a target="_blank" href="http://facebook.com/narbie1995">AMAL</a>.</strong> All rights
      reserved Department of M.Sc CS.
  </footer>
